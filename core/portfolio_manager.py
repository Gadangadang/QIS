...
# ==============================================================================
# BACKTEST FUNCTIONS (MOVED TO core/backtest.py)
# ==============================================================================
# NOTE: Backtest functionality has been moved to core/backtest.py
# These imports maintain backwards compatibility with existing code

try:
    from core.backtest import run_multi_asset_backtest, _run_backtest
except ImportError:
    def run_multi_asset_backtest(*args, **kwargs):
        raise ImportError(
            "Backtest functions have been moved to core.backtest module.\n"
            "Please update your imports:\n"
            "  from core.backtest import run_multi_asset_backtest"
        )
    _run_backtest = run_multi_asset_backtest
